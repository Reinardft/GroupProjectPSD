<%@ Page Title="" Language="C#" MasterPageFile="~/View/MasterPage.Master" AutoEventWireup="true" CodeBehind="UpdateEmployeePage.aspx.cs" Inherits="NeinteenFlower.View.UpdateEmployeePage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
      <asp:Label ID="EmailLbl" runat="server" Text="Email : "></asp:Label>
            ...
            <br />
            <br />
            <asp:Button ID="UpdateBtn" runat="server" Text="Update Employee" OnClick="UpdateBtn_Click" />
</asp:Content>
